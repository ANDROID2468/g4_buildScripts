#!/bin/bash
echo "ANDROID2468's build script for lineage OS"
...
breakfast lineage_vs986_usu-userdebug | tee -a log_vs986_usu.txt
brunch lineage_vs986_usu-userdebug | tee -a log_vs986_usu.txt
...
breakfast lineage_h810_usu-userdebug | tee -a log_h810_usu.txt
brunch lineage_h810_usu-userdebug | tee -a log_h810_usu.txt
...
breakfast lineage_h811-userdebug | tee -a log_h811.txt
brunch lineage_h811-userdebug | tee -a log_h811.txt
...
breakfast lineage_h812_usu-userdebug | tee -a log_h812_usu.txt
brunch lineage_h812_usu-userdebug | tee -a log_h812_usu.txt
...
breakfast lineage_h815-userdebug | tee -a log_h815.txt
brunch lineage_h815-userdebug | tee -a log_h815.txt
...
breakfast lineage_h815_usu-userdebug | tee -a log_h815_usu.txt
brunch lineage_h815_usu-userdebug | tee -a log_h815_usu.txt
